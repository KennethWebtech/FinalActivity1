...
const onDelete =(id) => {
    ...
    if(window.confirm("are you sure that you want to delete the data?")){
...
const filterData = (value) => {
  ...
  return (
    <div style={{
        ...
        <select className='dropdown' name="colValue" onChange={handleChange} style={{color: "white"}}>
            <option>Please Select</option>
            <option style={{color: "Black"}} value="name">Name</option>
            <option style={{color: "Black"}} value="email">Email</option>
            <option style={{color: "Black"}} value="contact">Contact</option>
            <option style={{color: "Black"}} value="status">Status</option>
        </select>
